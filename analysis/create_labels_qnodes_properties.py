...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--node2-labels', action='store', dest='node2_label')
    ...
    node2_label = args.get('node2_label')
    ka = KGTKAnalysis(folder_path)
    ka.property_english_labels_only(properties_label, qnodes_label, node2_label)
